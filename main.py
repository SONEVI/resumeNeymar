...
def text_handle(message):
    if message.text.strip() == 'Позвоните мне.':
        ...
        bot.send_poll(message.chat.id, question='Кому Неймар забил первый гол за Барселону?',
                      ...
                      explanation='Каталонцы сумели отыграться на 66-й минуте благодаря точному удару Неймара. '
                                  'Для бразильца этот мяч стал первым за испанский клуб в официальных матчах.',
